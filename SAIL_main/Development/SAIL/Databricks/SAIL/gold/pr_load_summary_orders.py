...
<<<<<<< HEAD
  ...
  FTOR.ORDER_REF_8_VALUE as ORDER_REF_8_VALUE, --change log UPSGLD-15869      
  cast ( NULL as string) as ORDER_REF_9_LABEL,      
  FTOR.ORDER_REF_9_VALUE as ORDER_REF_9_VALUE, --change log UPSGLD-15869       
  cast ( NULL as string) as ORDER_REF_10_LABEL,      
  FTOR.ORDER_REF_10_VALUE as ORDER_REF_10_VALUE,--change log UPSGLD-15869        
  cast ( NULL as string) as ORDER_REF_11_LABEL,      
  FTOR.ORDER_REF_11_VALUE as ORDER_REF_11_VALUE,--change log UPSGLD-15869        
  cast ( NULL as string) as ORDER_REF_12_LABEL,      
  FTOR.ORDER_REF_12_VALUE as ORDER_REF_12_VALUE, --change log UPSGLD-15869       
  cast ( NULL as string) as ORDER_REF_13_LABEL,      
  FTOR.ORDER_REF_13_VALUE as ORDER_REF_13_VALUE,--change log UPSGLD-15869        
